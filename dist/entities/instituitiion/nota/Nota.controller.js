...
const Nota_service_1 = require("./Nota.service");
const uuid_1 = require("uuid");
const prisma = new client_1.PrismaClient();
const service = new Nota_service_1.NotaService();
class NotaController {
    ...
    update(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const country = yield prisma.nota
                .findUnique({
                where: {
                    id,
                },
    ...
    delete(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const country = yield prisma.nota.findUnique({
                where: {
                    id,
                },
            });
