...
const service = new Administrador_service_1.AdministradorService();
class AdministradorController {
    ...
    update(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const province = yield prisma.administrador
                .findUnique({
                where: {
                    id,
                },
    ...
    delete(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const province = yield prisma.administrador.findUnique({
                where: {
                    id,
                },
            });
